...
float2* sdata = (float2*)shared;
	...
	unsigned int LUTId=0;
		if ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512) < 65536) {
		inoutID = (1 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_0=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 64) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_1=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_2=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 192) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_3=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 256) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_4=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 320) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_5=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 384) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
			temp_6=inputs[inoutID];
		inoutID = (1 * (threadIdx.y + 448) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)+(((threadIdx.x + blockIdx.x * blockDim.x)) / 320) * (512));
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) + (inoutID) * 320;
	...
	temp_6 = loc_0;
		...
		inoutID = (threadIdx.y + 0) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_0;
		inoutID = (threadIdx.y + 64) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_1;
		inoutID = (threadIdx.y + 128) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_2;
		inoutID = (threadIdx.y + 192) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_3;
		inoutID = (threadIdx.y + 256) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_4;
		inoutID = (threadIdx.y + 320) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_5;
		inoutID = (threadIdx.y + 384) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
			outputs[inoutID] = temp_6;
		inoutID = (threadIdx.y + 448) * (128) + ((((threadIdx.x + blockIdx.x * blockDim.x)) / 320) % (1)) * (128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 320);
			inoutID = (((threadIdx.x + blockIdx.x * blockDim.x)) % (320)) * 1 + (inoutID) * 320;
